...
public class RoughSet_Drsa_Ranking_Rules {
    public static void main(String[] args) throws Exception {
        final ArrayList<String> argsList = new ArrayList<>(Arrays.asList(args));
        if (argsList.remove("--v2")) {
            RoughSet_Drsa_Ranking_RulesCLI_XMCDAv2.main(argsList.toArray(new String[]{}));
        } else if (argsList.remove("--v3")) {
            RoughSet_Drsa_Ranking_RulesCLI_XMCDAv3.main(argsList.toArray(new String[]{}));
        } else {
