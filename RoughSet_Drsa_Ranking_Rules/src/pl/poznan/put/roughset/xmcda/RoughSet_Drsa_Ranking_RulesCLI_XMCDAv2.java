...
public class RoughSet_Drsa_Ranking_RulesCLI_XMCDAv2 {
    public static void main(String[] args) throws Utils.InvalidCommandLineException {
        ...
        Utils.loadXMCDAv2(xmcda_v2, new File(indir, "preferences_S.xml"), true,
                executionResult, "alternativesComparisons");
        Utils.loadXMCDAv2(xmcda_v2, new File(indir, "preferences_Sc.xml"), true,
                executionResult, "alternativesComparisons");
